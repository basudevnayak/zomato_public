        ...
        <View style={styles.container}>
            ...
            <ScrollView contentContainerStyle={styles.scrollContainer}>
                ...
                <View style={styles.flexRowBetween}>
                    ...
                    <Icon iconFamily='MaterialCommunityIcons' name='chevron-right' size={RFValue(16)} color={Colors.text} />
                </View>
                ...
                <View style={styles.flexRowBetween}>
                    <View>
                        ...
                        <CustomText fontSize={9} style={styles.cancelText} fontFamily='Okra-Bold'>Orders cannot be cancelled once packed for delivery. In case of unexpected delays, a refund will be provided, if applicable</CustomText>
                    </View>
                </View>
            ...
            <View style={styles.paymentGateway}>
                <View style={{ width: '30%' }}>
                    ...
                    <CustomText fontSize={10} style={{ marginTop: 2 }} fontFamily='Okra-Medium'>Cash on Delivery</CustomText>
                </View>
                <View style={{ width: "70%" }}>
                    <ArrowButton
                        loading={loading}
