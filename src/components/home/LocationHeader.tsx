                ...
                <View style={styles.flexRowGap}>
                    ...
                    <View>
                        <TouchableOpacity style={styles.flexRow}>
                            <CustomText variant='h5' color={textColor} fontFamily='Okra-Bold'>Erangel, Pochinki</CustomText>
                            <Icon name='chevron-down' color={textColor} iconFamily='MaterialCommunityIcons' size={18} />
                        </TouchableOpacity>
                        <CustomText color={textColor} fontFamily='Okra-Medium'>Lucknow, Uttar Pradesh</CustomText>
                    </View>
                </View>
