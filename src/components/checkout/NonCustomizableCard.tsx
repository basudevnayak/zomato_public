            ...
            <View style={styles.cartOperationContainer}>
                <View style={styles.miniAddButtonContainer}>
                    <TouchableOpacity onPress={removeCartHandler} >
                        <Icon iconFamily='MaterialCommunityIcons' color={Colors.active} name='minus-thick' size={RFValue(10)} />
                    </TouchableOpacity>
                    <AnimatedNumber
                        includeComma={false}
                    ...
                    <TouchableOpacity onPress={addCartHandler} >
                        <Icon iconFamily='MaterialCommunityIcons' color={Colors.active} name='plus-thick' size={RFValue(10)} />
                    </TouchableOpacity>
                </View>
