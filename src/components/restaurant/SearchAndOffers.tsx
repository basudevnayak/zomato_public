        ...
        <View style={styles.container}>
            <View style={[styles.flexRowBetween, styles.padding]}>
                <TouchableOpacity style={styles.searchInputContainer} activeOpacity={0.8} >
                    <Icon iconFamily='Ionicons' name='search' color={Colors.active} size={RFValue(20)} />
                    <RollingBar interval={3000} defaultStyle={false} customStyle={styles.textContainer}>
                        {searchItems?.map((item, index) => {
                            return (
                                <CustomText style={styles.rollingText} key={index} fontSize={12} fontFamily='Okra-Medium'>
                                    {item}
                                </CustomText>
                            )
                        })}
                ...
                <TouchableOpacity style={styles.flexRowGap}>
                    <Icon iconFamily='MaterialCommunityIcons' name='silverware-fork-knife' color={Colors.background} size={RFValue(16)} />
                    ...
                    >
                        <View style={{
                            ...
                            >
                                ...
                                <Icon iconFamily='MaterialCommunityIcons' name='arrow-right-circle' color='#fff' size={RFValue(14)} />
                            </TouchableOpacity>
